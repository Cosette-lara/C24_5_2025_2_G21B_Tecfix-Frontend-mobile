// Archivo: lib/models/incidencia_model.dart
// (Versión corregida del error de import)

// --- INICIO DE CORRECCIÓN ---
import 'package:flutter/material.dart'; // Corregido de 'package.flutter' a 'package:flutter'
// --- FIN DE CORRECCIÓN ---

import 'package:intl/intl.dart';

// Modelo para el historial de cambios (RF-13)
...
class IncidenciaDetalle {
  ...
  final String fecha;
  final String estado;
  final Color colorEstado; // Esta clase ahora será reconocida
  ...
  factory IncidenciaDetalle.fromJson(Map<String, dynamic> json) {
    ...
    Color color = Colors.grey; // <-- Corregido
